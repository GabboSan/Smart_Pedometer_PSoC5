// ======================================================================
// MPU920_I2C.v generated from TopDesign.cysch
// 02/09/2022 at 20:08
...
module UART_v2_50_0 (
	...
	cy_clock_v1_0
		#(.id("14d96432-9815-4fab-bbfe-9999f86c4af9/be0a0e37-ad17-42ca-b5a1-1a654d736358"),
		  .source_clock_id(""),
		  .divisor(0),
...
module top ;
	...
	cy_psoc3_pins_v1_10
		#(.id("01f911ba-f562-4e7a-85e0-169b33940dc1"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("4017179e-7254-4975-89b0-f5e621071bcf"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
    ...
    UART_v2_50_0 UART_USB (
        ...
        .rx_clk(Net_175),
        .rx_data(Net_176),
        .rx_interrupt(Net_177),
        .tx(Net_178),
        .tx_clk(Net_179),
        .tx_data(Net_180),
        .tx_en(Net_181),
        .tx_interrupt(Net_182));
    ...
    I2C_v3_50_1 I2C_MPU9250_Master (
        .bclk(Net_49),
        .clock(1'b0),
        .iclk(Net_50),
        .itclk(Net_55),
	...
	wire [0:0] tmpOE__Connection_Led_net;
	wire [0:0] tmpFB_0__Connection_Led_net;
	wire [0:0] tmpIO_0__Connection_Led_net;
	wire [0:0] tmpINTERRUPT_0__Connection_Led_net;
	...
	assign tmpOE__Connection_Led_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_clock_v1_0
		#(.id("c2d6a3ec-ff35-4e24-97bf-0c8197f3be7a"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("100000000000"),
		  .is_direct(0),
    ...
    UART_v2_50_3 UART_Debug (
        ...
        .rx_clk(Net_162),
        .rx_data(Net_163),
        .rx_interrupt(Net_164),
        .tx(Net_165),
        .tx_clk(Net_166),
        .tx_data(Net_167),
        .tx_en(Net_168),
        .tx_interrupt(Net_169));
	...
	wire [0:0] tmpOE__Pin_Wake_net;
	wire [0:0] tmpFB_0__Pin_Wake_net;
	wire [0:0] tmpIO_0__Pin_Wake_net;
	electrical [0:0] tmpSIOVREF__Pin_Wake_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("8d318d8b-cf7b-4b6b-b02c-ab1c5c49d0ba"),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_Wake
		 (.oe(tmpOE__Pin_Wake_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pin_Wake_net[0:0]}),
		  .io({tmpIO_0__Pin_Wake_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_Wake_net),
		  .interrupt({Net_133}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__Pin_Wake_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
