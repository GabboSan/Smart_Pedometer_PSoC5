...
*/
    ...
    */
    ...
    /* ========= TYPE DEFS ========= */
    /** 
     * @brief Initial settings for the MPU9250
    **/
    ...
    */
    ...
    /**
    * @brief Init component's operations.
    *
    *this function substitute a chain of operations necessary to start MPU
    */
    void init_MPU(void);
    /**
